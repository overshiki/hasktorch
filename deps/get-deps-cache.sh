  ...
  case "$(uname)" in
    ...
    "Linux")
      if [ "$USE_NIGHTLY" = 1 ] ; then
        ...
        if [ ! -e ${COMPUTE_ARCH}-libtorch-cxx11-abi-shared-with-deps-latest ] ; then
